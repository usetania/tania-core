...
<template lang="pug">
  .materials-create
    .modal-header
      span.h4.font-bold Add New Agrochemical
    .modal-body
      form(@submit.prevent="validateBeforeSubmit")
        ...
        .form-group
          .row
            .col-xs-6
              label(for="type") Chemical TYpe
              select#type.form-control
                option Disinfectant &amp; Sanitizer
                option Fertilizer
                option Hormone &amp; Growth Agent
                option Manure
                option Pesticide
            .col-xs-6
                ...
                .row
                  .col-xs-6
                    select.form-control
                      ...
                      option Bottles
                  .col-xs-6
                    input.form-control#quantity(name="quantity")
        .form-group
          .row
            .col-xs-6
...
<script>
export default {
  name: 'InventoriesMaterialsCreateAc',
  methods: {
