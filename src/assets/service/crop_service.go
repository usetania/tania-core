...
func (s CropService) ChangeInventory(crop *domain.Crop, inventory domain.InventoryMaterial) error {
	if inventory.Variety == "" {
		return domain.InventoryMaterialError{Code: domain.InventoryMaterialInvalidVariety}
	}
